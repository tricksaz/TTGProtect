...
bot.on("guildCreate", function(guild) {
    ...
    const embed = new Discord.RichEmbed()
        ...
        .addField(`:wave: Welcome!`, `Thanks for adding Cloud to your server! You might be wondering, how do I setup Cloud? Well, I'll show you.`)
        ...
        .addField(`Anything Else?`, `If there is, you can always join the support server or DM a Developer. Developers you can message include ` + "`Tricks`" + `. The support server should be in the ` + "`about`" + ` command`)
        .setColor(0x00ff00)
